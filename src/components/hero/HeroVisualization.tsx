    ...
    <div className="flex h-full w-full items-center justify-center">
      ...
      >
        ...
        >
          ...
          <path d="M -80 -90 L -80 70 M -40 -110 L -40 50 M 40 -110 L 40 50 M 80 -90 L 80 70" opacity="0.25" />
          <path d="M -120 -30 L 120 -30 M -120 10 L 120 10 M -120 50 L 120 50" opacity="0.25" />
          {/* Nodes */}
          {[
            [-120, -70], [0, -130], [120, -70], [0, -10],
            [-120, 90], [120, 90], [0, 150],
          ].map(([x, y], i) => (

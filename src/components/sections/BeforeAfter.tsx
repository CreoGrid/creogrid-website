                ...
                <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-6">
                    ...
                    >
                        ...
                        <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                            Business information lives everywhere—spreadsheets, WhatsApp, emails,
                            machines, paperwork and disconnected software. Teams spend more time
                            searching, updating and reconciling data than actually growing the
                            business.
                        </p>
                    ...
                    <div className="rounded-3xl border border-primary/20 bg-card p-6 shadow-[var(--shadow-card-hover)] sm:p-8">
                        ...
                        <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                            Every department, employee, customer, machine and software system works
                            through one intelligent platform. AI automates repetitive work, connects
                            data across the organization and provides real-time insights for faster,
                            better decisions.
                        </p>
                        <div className="relative mt-6 h-[360px] w-full">
                            <svg viewBox="0 0 260 350" className="h-full w-full">

            ...
            <div className="container-page grid grid-cols-1 items-center gap-12 py-12 md:grid-cols-2 md:gap-16 md:py-20">
                ...
                >
                    ...
                    >
                        ...
                        business—giving you complete control while enabling operational excellence,
                        exceptional customer experiences, and a smarter business that runs more
                        efficiently, grows faster, and scales effortlessly.
                    </motion.p>

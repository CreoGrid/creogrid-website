    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    background:
                        "linear-gradient(135deg, rgba(58,93,226,0.5), rgba(123,92,255,0.5), rgba(0,212,255,0.3))",
                }}
            />
            ...
            <div className="relative w-[75%] xs:w-full glass-card rounded-2xl overflow-hidden border border-torqone-border">
                ...
                <div className="flex items-center justify-between px-5 py-3.5 border-b border-torqone-border/60 bg-torqone-card/80">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="max-xs:hidden text-xs text-torqone-text-muted ml-2 font-mono">
                            torqone.app / dashboard
                        </span>
                    </div>
                ...
                <div className="p-5 space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        {[
                            ...
                            <div
                                key={kpi.label}
                                className="rounded-xl bg-torqone-background/60 border border-torqone-border/60 p-3"
                            >
                                <div className="flex items-center justify-between mb-1.5">
                                    <kpi.icon className={`w-3.5 h-3.5 ${kpi.color}`} />
                                    <span className="text-[10px] text-torqone-success font-medium">
                                        {kpi.change}
                                    </span>
                                </div>
                                <p className="text-base font-bold text-white leading-none mb-0.5">
                                    {kpi.value}
                                </p>
                                <p className="text-[10px] text-torqone-text-muted leading-none">
                                    {kpi.label}
                                </p>
                            </div>
                        ))}
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2 mb-1">
                                    <span className="text-xs font-semibold text-torqone-ai">
                                ...
                                <p className="text-xs text-torqone-text-secondary leading-relaxed">
                                    17 members haven&apos;t visited in 9 days. WhatsApp
                                    re-engagement sent automatically. 4 already rebooked. Projected
                                    recovery:{" "}
                                    <span className="text-white font-semibold">₹4,140/month</span>.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-2.5">
                            <span className="text-xs font-semibold text-torqone-text-secondary">
                                Live Activity
                            </span>
                        ...
                        <div className="space-y-2">
                            {[
                                {
                                    icon: Users,
                                    color: "bg-torqone-primary",
                                    msg: "Lead from Instagram ad — auto WhatsApp follow-up sent",
                                    time: "2s ago",
                                },
                                {
                                    icon: Activity,
                                    color: "bg-torqone-success",
                                    msg: "Payment collected — GST invoice auto-generated",
                                    time: "14s ago",
                                },
                                {
                                    icon: Sparkles,
                                    color: "bg-torqone-ai",
                                    msg: "AI sent birthday wishes + referral nudge to 12 members",
                                    time: "1m ago",
                                },
                                {
                                    icon: BarChart3,
                                    color: "bg-torqone-warning",
                                    msg: "Monday Growth Report delivered — 3 at-risk members flagged",
                                    time: "3m ago",
                                },
                            ].map((item, i) => (
                                <motion.div
                                ...
                                >
                                    <div
                                        className={`w-6 h-6 rounded-lg ${item.color} flex items-center justify-center flex-shrink-0`}
                                    >
                                        <item.icon className="w-3 h-3 text-white" />
                                    </div>
                                    <span className="flex-1 text-[11px] text-torqone-text-secondary truncate">
                                        {item.msg}
                                    </span>
                                    <span className="text-[10px] text-torqone-text-muted shrink-0">
                                        {item.time}
                                    </span>
                                </motion.div>
                            ))}
...
export function Hero() {
  ...
  {" "}Modern */}
                        ...
                        >
                            Every day you lose valuable time on manual follow-ups, missed leads,
                            silent drop-offs, disconnected tools and late-night spreadsheet
                            sessions. TorqOne runs & unifies everything for you — Customer
                            Acquisition, Retention, Marketing, Billing, Trainers, and Growth along
                            with Member management, Operations, Business intelligence, AI
                            Automations, Dashboards and CRM into one intelligent platform— so you
                            can spend less time managing your gym and more time growing it.
                        </motion.p>

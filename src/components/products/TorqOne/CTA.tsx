        ...
        <ScrollReveal>
          <div className="relative rounded-3xl overflow-hidden">
            ...
            <motion.div
              ...
              style={{ background: 'radial-gradient(circle, rgba(123,92,255,0.3) 0%, transparent 70%)' }}
              animate={{ scale: [1, 1.1, 1], opacity: [0.5, 0.8, 0.5] }}
              transition={{ duration: 6, repeat: Infinity, ease: 'easeInOut' }}
            />
            <motion.div
              className="absolute -bottom-20 -left-20 w-72 h-72 rounded-full blur-3xl"
              style={{ background: 'radial-gradient(circle, rgba(58,93,226,0.3) 0%, transparent 70%)' }}
            ...
            <div className="relative px-6 py-20 lg:px-16 lg:py-24 text-center">
              ...
              >
                You opened a gym to change lives.<br />
              ...
              >
                From the first lead to the next renewal, TorqOne brings your members, operations, growth, AI and automation into one intelligent system — working every day to help your gym run better and grow faster at a quantum level.
              </motion.p>
              ...
              >
                14-day free trial · WhatsApp automations from day one · AI-powered Customer retention from day one
              </motion.p>
            </div>
          </div>
        </ScrollReveal>

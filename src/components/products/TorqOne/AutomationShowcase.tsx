...
function SummaryCard() {
    return (
        <div
            className="relative overflow-hidden rounded-3xl border border-torqone-border/80 bg-torqone-card/60 backdrop-blur-xl p-6 md:p-8 shadow-2xl transition-all duration-300 hover:border-torqone-border hover:shadow-torqone-primary/5 group"
      ...
      `}</style>
            ...
            <div className="flex items-center justify-between mb-6">
                <Badge
                    ...
                    pulse
                    size="sm"
                    className="bg-torqone-success-muted/5 border-torqone-success/20 text-[10px] md:text-xs"
                >
            ...
            <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-torqone-text-secondary leading-relaxed">
                        Thousands of routine tasks happen automatically every week—without anyone
                        remembering to do them. TorqOne continuously monitors your business,
                        triggers the right workflows at the right time, and keeps members engaged
                        from their very first enquiry to long after they join.
                    </p>
                </div>
            </div>
...
function FlowCard({ flow }: { flow: (typeof FLOWS)[0] }) {
    return (
        <div
            className="rounded-2xl bg-torqone-card border p-5 h-full"
            style={{ borderColor: flow.border }}
        >
            {/* Header */}
                ...
                {flow.steps.map((step, i) => (
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0 flex items-center justify-between gap-2">
                            <span className="text-xs text-torqone-text-secondary">
                                {step.label}
                            </span>
                            <span

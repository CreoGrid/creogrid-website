            ...
            <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                <ScrollReveal>
                    <SectionHeading
                        ...
                        title={
                            <>
                                Built for the gym of tomorrow. Not yesterday. <br />{" "}
                                <GradientText>TorqOne vs everything else.</GradientText>
                            </>
                        }
                ...
                <ScrollReveal delay={0.1}>
                    <div className="glass-card rounded-2xl overflow-hidden">
                        ...
                        <div className="grid grid-cols-[1.5fr_1fr_1fr_1fr] border-b border-torqone-border">
                            <div className="p-5">
                                <span className="text-[10px] ssm:text-xs font-semibold tracking-wider uppercase text-torqone-text-muted">
                                    Capability
                                </span>
                            </div>
                            <div className="relative px-[5px] py-5 ssm:px-5 ssm:py-5 text-center bg-torqone-primary-muted border-x border-torqone-primary/30">
                                ...
                                <div className="flex items-center justify-center gap-1.5 mb-1">
                                    ...
                                    <span className="text-[11px] ssm:text-sm font-bold text-white">
                                        TorqOne
                                    </span>
                                </div>
                                <Badge variant="ai" size="sm" className="max-ssm:hidden">
                                    Enterprise Intelligent Platform
                                </Badge>
                            </div>
                            <div className="px-[5px] py-5 ssm:px-5 ssm:py-5 text-center">
                                <span className="text-[11px] ssm:text-sm font-semibold text-torqone-text-secondary">
                                    Traditional Gym Software
                                </span>
                            </div>
                            <div className="px-[5px] py-5 ssm:px-5 ssm:py-5 text-center">
                                <span className="text-[11px] ssm:text-sm font-semibold text-torqone-text-secondary">
                        ...
                        {ROWS.map((row, i) => (
                            ...
                            >
                                <div className="px-[5px] py-5 ssm:px-4 ssm:py-4 text-[11px] ssm:text-sm text-torqone-text-secondary">
                                    {row.feature}
                                </div>
                                ...
                                <div className="px-[5px] py-5 ssm:px-4 ssm:py-4 text-center">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-6 mt-6 text-xs text-torqone-text-muted">
                        <span className="flex items-center gap-1.5">
                            <span className="w-4 h-4 rounded-full bg-torqone-success-muted border border-torqone-success/30 flex items-center justify-center">
                                <Check
                                    className="w-2.5 h-2.5 text-torqone-success"
                                    strokeWidth={3}
                                />
                            </span>
                            Fully supported
                        ...
                        <span className="flex items-center gap-1.5">
                            <span className="w-4 h-4 rounded-full bg-torqone-error-muted border border-torqone-error/20 flex items-center justify-center">
                                <X
                                    className="w-2.5 h-2.5 text-torqone-error/60"
                                    strokeWidth={2.5}
                                />
                            </span>
                            Not available

                    ...
                    <SectionHeading
                        ...
                        title={
                            <>
                                ...
                                <br />
                                <GradientText>never look back.</GradientText>
                            </>
                        }
                            ...
                            >
                                ...
                                <div className="flex gap-0.5 mb-4">
                                    {Array.from({ length: 5 }).map((_, i) => (
                                        <Star
                                            key={i}
                                            className="w-3.5 h-3.5 text-torqone-warning fill-torqone-warning"
                                        />
                                    ))}
                                </div>
                                ...
                                <div className="flex items-center gap-3 pt-4 border-t border-torqone-border/50">
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        <p className="text-xs text-torqone-text-muted truncate">
                                            {t.role}
                                        </p>
                                    </div>
                                    <div className="ml-auto text-right shrink-0">
                                        <p className="text-xs text-torqone-text-secondary font-semibold">
                                            {t.locations} loc.
                                        </p>

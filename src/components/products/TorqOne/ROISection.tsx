                    ...
                    <SectionHeading
                        ...
                        title={
                            <>
                                ...
                                <br />
                                <GradientText>switch to TorqOne.</GradientText>
                            </>
                        }
                                ...
                                {COMPARISONS.map((c, i) => (
                                    <div key={c.metric}>
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            ...
                                            <div>
                                                <div className="flex items-center justify-between mb-1">
                                                    <span className="text-[10px] text-torqone-primary">
                                                        After
                                                    </span>
                                                    <span className="text-[10px] text-torqone-primary font-mono">
                                                        {c.after}
                                                    </span>
                                                </div>
                                                <div className="h-2 rounded-full bg-torqone-background overflow-hidden">
                        ...
                        <ScrollReveal>
                            <div className="glass-card rounded-2xl p-6">
                                ...
                                <div className="flex items-end gap-1 h-32 mb-4">
                                    {[40, 48, 55, 62, 70, 78, 85, 92, 100, 108, 115, 125].map(
                                        (h, i) => (
                                            <motion.div
                                                key={i}
                                ...
                                <div className="flex items-center justify-between text-xs">
                                    ...
                                    <span className="text-torqone-success font-semibold">
                                        +$340K projected
                                    </span>
                            ...
                            {[
                                ...
                                <StaggerItem key={item.label}>
                                    <div className="rounded-xl border border-torqone-border/60 bg-torqone-card/50 p-4">
                                        ...
                                        <p className="text-xs text-torqone-text-muted">
                                            {item.label}
                                        </p>
                                    </div>
                                </StaggerItem>

    ...
    return (
        <div className="relative w-full max-w-[560px] sm:max-w-[640px] xl:max-w-[520px] mx-auto aspect-square">
            <div
                ...
                style={{
                    background:
                        "radial-gradient(circle at center, rgba(123,92,255,0.5) 0%, transparent 65%)",
                }}
            />
            <svg
                viewBox="0 0 555 540"
                className="w-full h-full relative"
                aria-label="TorqOne Operating System architecture"
            >
                {/* Ring guides */}
                <circle
                    cx={cx}
...
const FEATURE_SECTIONS: {
...
}[] = [
    {
        ...
        description:
            "Every app your gym needs — for owners, members, and trainers — in one connected suite.",
        elevated: true,
        features: [
    ...
    },
    {
        ...
        description:
            "Workouts, nutrition, gamification, and AI motivation that keeps members engaged.",
        features: [
            { label: "Workout Plans" },
    ...
    },
    {
        ...
        description:
            "A dedicated mobile app for trainers to manage members, workouts, and bookings.",
        features: [
    ...
    },
    {
        ...
        description:
            "Smart Reception, scheduling, inventory, POS, and complete day-to-day operations.",
        features: [
    ...
    },
    {
        ...
        description:
            "AI-powered campaigns, referrals, loyalty programs, and a self-learning marketing engine.",
        features: [
    ...
    },
    {
        ...
        description:
            "Predictive insights, personalized messages, and proactive business assistance.",
        features: [
    ...
    },
    {
        ...
        description:
            "Executive dashboards, revenue forecasting, and AI-powered business recommendations.",
        features: [
    ...
    },
    {
        ...
        description:
            "Multi-branch management, advanced permissions, enterprise security, and white-label.",
        features: [
    ...
    },
    {
        ...
        description:
            "Enterprise-grade hosting, automatic backups, disaster recovery, and continuous monitoring.",
        features: [
    ...
    },
    {
        ...
        description:
            "We migrate your existing members, plans, history, and data from any previous system.",
        features: [
    ...
    if (Icon) {
        return (
            <span
                ...
                style={{
                    background: "rgba(58,93,226,0.1)",
                    borderColor: "rgba(58,93,226,0.3)",
                    color: "#B7C2D0",
                }}
            >
...
function FeatureSectionBlock({
    ...
    section: (typeof FEATURE_SECTIONS)[0];
    index: number;
}) {
    return (
        <motion.div
            ...
            style={
                section.elevated
                    ? {
                          background:
                              "linear-gradient(135deg, rgba(58,93,226,0.08) 0%, rgba(123,92,255,0.05) 100%)",
    ...
    return (
        <div className="relative h-full">
            <div
                ...
                style={{
                    background:
                        "radial-gradient(circle at top, rgba(123,92,255,0.5), transparent 70%)",
                }}
            />
            <div className="relative glass-card rounded-2xl p-6 h-full overflow-hidden">
                ...
                <p className="text-sm text-torqone-text-secondary leading-relaxed mb-5">
                    TorqOne continuously watches attendance, renewals, payments, leads, member
                    engagement and business performance. It predicts problems before they become
                    losses, automates repetitive work, and delivers recommendations every week — so
                    your business keeps improving even when you&apos;re busy running it.
                </p>
                ...
                <div className="grid grid-cols-3 gap-2">
                    {watchItems.map((item, i) => (
                        ...
                        >
                            ...
                            <span className="text-[10px] text-torqone-text-muted font-medium">
                                {item.label}
                            </span>
                        </motion.div>
                    ))}
    ...
    return (
        <div className="relative h-full">
            <div
                ...
                style={{
                    background:
                        "radial-gradient(circle at top, rgba(58,93,226,0.5), transparent 70%)",
                }}
            />
            <div className="relative glass-card rounded-2xl p-6 h-full">
                ...
                <p className="text-sm text-torqone-text-secondary leading-relaxed mb-5">
                    Instead of switching between WhatsApp, Excel, Google Sheets, phone calls,
                    printers, notebooks, POS, CRM, attendance registers and billing software —
                    everything happens inside TorqOne.
                </p>

                <div className="grid grid-cols-2 gap-4">
                    {/* Old Way */}
                    <div>
                        <p className="text-[10px] font-semibold uppercase tracking-wider text-torqone-error mb-2.5">
                            Old Way
                        </p>
                        <div className="space-y-1">
                            {oldWay.map((tool, i) => (
                                ...
                                >
                                    ...
                                    {i < oldWay.length - 1 && (
                                        <ChevronRight className="w-2.5 h-2.5 text-torqone-error/40 rotate-90" />
                                    )}
                                </motion.div>
                            ))}
                            <div className="flex items-center justify-center pt-1">
                                <span className="text-[9px] text-torqone-error/60">
                                    Owner overwhelmed
                                </span>
                            </div>
                        </div>
                    ...
                    {/* New Way */}
                    <div>
                        <p className="text-[10px] font-semibold uppercase tracking-wider text-torqone-success mb-2.5">
                            New Way
                        </p>
    ...
    return (
        <div className="relative h-full">
            <div
                ...
                style={{
                    background:
                        "radial-gradient(circle at top, rgba(0,212,255,0.5), transparent 70%)",
                }}
            />
            <div className="relative glass-card rounded-2xl p-6 h-full overflow-hidden">
                ...
                <p className="text-sm text-torqone-text-secondary leading-relaxed mb-5">
                    From the first ad click to a loyal, referring member — every step is automated,
                ...
                <div className="flex justify-center items-stretch gap-x-2">
                    ...
                    <div className="relative flex flex-col items-center self-stretch w-5 py-1">
                        ...
                        <div
                            ...
                            style={{ background: `${crossColor}40` }}
                        />
                        <motion.div
            ...
            <ScrollReveal>
                <div className="text-center mb-10">
                    ...
                    <p className="text-sm text-torqone-text-secondary max-w-2xl mx-auto leading-relaxed">
                        From the moment they join to the day they become a long-term advocate —
                        TorqOne guides every step of their fitness journey with AI-powered
                        engagement, tracking, and motivation.
                    </p>
                </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.1}>
                <div className="relative glass-card rounded-2xl p-6 overflow-hidden">
                    <div
                        ...
                        style={{
                            background:
                                "linear-gradient(90deg, rgba(58,93,226,0.3), rgba(123,92,255,0.3), rgba(0,212,255,0.3))",
                        }}
                    />
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <ScrollReveal>
                    <SectionHeading
                        ...
                        title={
                            <>
                                What if every part of your gym
                                <br />
                                <GradientText>
                                    worked together as one intelligent system?
                                </GradientText>
                            </>
                        }
                ...
                <div className="relative glass-card rounded-3xl p-6 sm:p-8 mb-20 overflow-hidden">
                    <div
                        ...
                        style={{
                            background:
                                "radial-gradient(circle at 30% 40%, rgba(123,92,255,0.4), transparent 60%)",
                        }}
                    />

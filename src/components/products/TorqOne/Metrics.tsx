...
const METRICS = [
  { icon: Users,     target: 4800,  prefix: '',  suffix: '+',  label: 'Members Recovered',       color: '#3A5DE2', bg: 'rgba(58,93,226,0.1)' },
  { icon: Target,    target: 12500, prefix: '',  suffix: '+',  label: 'Leads Converted',          color: '#22C55E', bg: 'rgba(34,197,94,0.1)' },
  { icon: Clock,     target: 480,   prefix: '',  suffix: 'hrs',label: 'Staff Hours Saved / Month', color: '#00D4FF', bg: 'rgba(0,212,255,0.1)' },
  { icon: Sparkles,  target: 34000, prefix: '',  suffix: '+',  label: 'AI Actions Performed',     color: '#7B5CFF', bg: 'rgba(123,92,255,0.1)' },
];

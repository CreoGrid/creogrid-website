...
import { X, ArrowRight, CheckCircle2, Sparkles, User, Mail, Building2, Phone } from "lucide-react";
...
import { submitLead, type LeadFormState } from "@/actions/lead.action";
...
const Field = forwardRef<HTMLInputElement, FieldProps>(function Field(
    { label, icon, prefix, error, className, id, ...props },
    ref,
) {
    return (
        <div className="flex flex-col gap-1.5">
            <label
                htmlFor={id}
                className="text-xs font-semibold text-torqone-text-secondary tracking-wide"
            >
                {label}
            </label>
        ...
        >
            ...
            <div>
                ...
                <p className="text-sm text-torqone-text-secondary max-w-xs">
                    Our team will reach out within 24 hours to schedule your personalised TorqOne
                    demo.
                </p>
            </div>
                ...
                <>
                    ...
                    >
                        ...
                        <div
                            ...
                            style={{
                                background:
                                    "radial-gradient(ellipse, rgba(123,92,255,0.25) 0%, transparent 70%)",
                            }}
                        />
                      ...
                      <span className="text-xs font-semibold text-torqone-primary tracking-wide uppercase">
                        TorqOne
                                        ...
                                        <p className="text-sm text-torqone-text-secondary mt-1 leading-relaxed whitespace-nowrap">
                                            See how TorqOne can fit your gym's operations and
                                            growth.
                                        </p>
                                    </div>
                                    <button
                                ...
                                >
                                    ...
                                    <p className="text-[11px] text-torqone-text-muted text-center">
                                        No credit card required · Setup in 48 hrs · WhatsApp
                                        automations from day one
                                    </p>
                                </form>
                            </>
                        )}

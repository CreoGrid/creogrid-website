...
export function GradientText({ variant = 'default', className, children, ...props }: GradientTextProps) {
  return (
    <span
      className={cn(
        variant === 'default' ? 'text-gradient' : 'text-gradient-ai',
        className
      )}
      {...props}
    >

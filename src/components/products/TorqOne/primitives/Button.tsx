...
const variantStyles: Record<ButtonVariant, string> = {
    ...
    ai: "bg-torqone-ai hover:bg-torqone-ai-hover text-white border border-torqone-ai/50 shadow-torqone-ai",
    ghost: "bg-transparent hover:bg-torqone-primary-muted text-torqone-text-secondary hover:text-white border border-transparent",
    outline:
    ...
    (
        ...
        return (
            <motion.button
                ...
                className={cn(
                    "relative inline-flex items-center justify-center font-semibold cursor-pointer",

                ...
                <div className="p-5 space-y-5">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        {feature.panel.stats.map((s) => (
                            <div
                                key={s.label}
                                className="rounded-xl bg-torqone-background/50 border border-torqone-border/60 p-3"
                            >
                                <p className="text-base font-bold text-white leading-none mb-1">
                                    {s.value}
                                </p>
                                <p className="text-[10px] text-torqone-text-muted mb-1 leading-none">
                                    {s.label}
                                </p>
                                <span
                    ...
                    <SectionHeading
                        ...
                        title={
                            <>
                                ...
                                <br />
                                <GradientText>Every problem solved.</GradientText>
                            </>
                        }
                            ...
                            return (
                                <button
                                    ...
                                    className={`relative flex flex-1 items-center justify-center gap-2 min-w-[90px] px-4 py-2.5 rounded-xl transition-colors duration-200 text-xs font-semibold ${
                                        isActive
                                            ? "text-white"
                                            : "text-torqone-text-muted hover:text-white"
                                    }`}
                                >
                                    {isActive && (
                                        <motion.div
                                    ...
                                    <span className="relative z-10 flex items-center gap-2">
                                        <f.icon
                                            className={`w-3.5 h-3.5 ${isActive ? f.color : ""}`}
                                        />
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-torqone-text-secondary leading-relaxed">
                                    {active.body}
                                </p>
                            </div>
                            <button
                                className={`flex items-center gap-1.5 text-sm font-semibold ${active.color} hover:opacity-80 transition-opacity`}
                            >

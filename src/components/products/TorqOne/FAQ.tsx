...
const FAQ_ITEMS = [
...

    {
        ...
        answer: "Yes. Multi-branch management is available from the Scale plan. You can manage branches, members, operations, inventory, finances, permissions, and performance from a unified platform. Enterprise expands this with unlimited branches, dedicated infrastructure, advanced integrations, and enterprise-level capabilities.",
    },

    {
        id: "11",
        question: "What happens if I start with Launch and later need more?",
        answer: "You can upgrade as your gym grows. Your existing data and configuration can continue with you as you move to Growth, Scale, or Enterprise. This lets a single-location gym start with the essentials and add AI, marketing, advanced business intelligence, POS, multi-branch management, and enterprise capabilities when they actually become useful.",
    },

    {
        id: "12",
        question: "How much AI usage is included in each plan?",
        answer: "Each plan includes a defined monthly AI allowance. Launch includes 100 Owner AI Operations and 20 AI Conversations per active member per month. Growth includes 250 Owner AI Operations and 30 member AI Conversations. Scale includes 600 Owner AI Operations and 40 member AI Conversations. Enterprise provides customized AI resources based on the requirements and usage of the business.",
    },

    {
        id: "13",
        question: "Is there a free trial?",
        answer: "Yes. TorqOne offers a 14-day free trial so you can explore the platform before committing. The exact features and usage available during the trial may vary depending on the plan and configuration. We can also help you understand which plan is appropriate for your gym before you subscribe.",
    },

    {
        id: "14",
        question: "What does the one-time onboarding and implementation fee cover?",
        answer: "The one-time onboarding fee covers platform configuration, initial setup, staff setup, data migration where included, and required integrations. The goal is to get your gym configured correctly rather than simply giving you access to the software and leaving you to set everything up yourself.",
    },

    {
        id: "15",
        question: "Can I use TorqOne if I already have gym management software?",
        answer: "Yes. You do not necessarily have to replace everything at once. We can assess your existing system and data, identify what needs to be migrated, and determine the best way to move to TorqOne. For gyms coming from spreadsheets or older software, the onboarding process can be especially useful for cleaning and organizing existing data.",
    },

    {
        id: "16",
        question: "Is my gym and member data secure?",
        answer: "TorqOne is designed with security, access control, backups, and reliable cloud infrastructure in mind. Access to business information can be controlled based on roles and permissions, while higher plans provide stronger infrastructure and enterprise capabilities. Specific security, backup, infrastructure, and compliance requirements can be discussed during Enterprise onboarding.",
    },
];
                    ...
                    <SectionHeading
                        ...
                        title={
                            <>
                                Questions?
                                <br />
                                <GradientText>We have answers.</GradientText>
                            </>
                        }
